  ...
  <v-content>
    ...
    <section id="about-me">
      ...
      <v-container class="text-center">
        ...
        <v-responsive
          class="mx-auto title font-weight-light mb-12"
          max-width="720"
        >
          I'm a senior Computer Science student at Montana State University.
          Seeking to use my programming and problem solving skills on Entry
          level or internship
        </v-responsive>
        <v-avatar class="elevation-12 mb-12" size="128">
          <v-img src="@/assets/image3.jpeg"></v-img>
        </v-avatar>
        <div></div>
